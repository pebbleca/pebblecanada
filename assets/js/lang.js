...
(function () {
  ...
  var T = {
    ...
    'tech-fed-p1':      'Federal technology engagements operate inside a structured compliance environment — the Canada Digital Ambition, Protected B cloud requirements, the Algorithmic Impact Assessment (AIA) framework, and TBS guidance on the responsible use of generative AI. Pebble Canada designs its technology delivery to be compliant with these frameworks from the outset.',
    ...
    'tech-fed-p3':      'The Government of Canada\'s Directive on Automated Decision-Making requires AIA completion, bias review, and explainability documentation for AI systems that affect individuals. Pebble Canada builds AIA-ready AI systems — with audit trails, human-in-the-loop checkpoints, and decision-log infrastructure built into the delivery model from day one.',
    ...
    'log-tc-p2':        'Supply chain resilience is about documentation discipline, customs compliance, and adaptability — not just speed. Pebble Canada manages the full logistics lifecycle: freight coordination, CBSA customs clearance, CUSMA and CETA compliance, trade finance coordination through Trade Commissioner channels, and delivery verification — giving operators a single accountable partner.',
    ...
    'log-tc-p4':        'International logistics failures are rarely about physical movement — they are about documentation errors, misclassified goods, missed permit requirements, or customs delays that cascade into project timelines. Pebble Canada\'s trade compliance capability — covering import/export documentation, tariff classification, permits, and origin certification under CUSMA and CETA — is integrated into every shipment.',
      ...
      'tech-stat2-label':  'Share of Canadian SMEs that had adopted AI tools as of 2023 — a significant productivity gap versus global peers.',
      'tech-stat2-source': '↗ BDC — AI in Canadian Business',
      'tech-stat3-label':  'Value of Canada’s information and communications technology sector — a foundation for domestic AI scale-up.',
      ...
      'def-stat1-label':   'Canada’s total defence budget for 2024–25 — the largest in Canadian history as commitments to NATO and continental security increase.',
      ...
      'log-stat2-label':   'Share of Canada’s trade flowing through Indo-Pacific markets — the fastest-growing corridor for Canadian exporters and importers.',
    ...
    'log-tc-p4':        'Les défaillances logistiques internationales concernent rarement les mouvements physiques — elles portent sur les erreurs documentaires, les marchandises mal classifiées ou les délais douaniers se répercutant sur les calendriers de projet. La capacité de conformité commerciale de Pebble Canada — couvrant la documentation d\'import/export, la classification tarifaire et la certification d\'origine ACEUM et AECG — est intégrée à chaque expédition.',
      ...
      'tech-stat3-label':  'Valeur du secteur des technologies de l’information et des communications du Canada — une base pour la mise à l’échelle nationale de l’IA.',
